...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_doc']))
		{
			...
			$rc=$stmt->bind_param('ssssss', $doc_fname, $doc_lname, $doc_number, $doc_email, $doc_pwd, $doc_dept);
			$stmt->execute();
			/*
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="inputState" class="col-form-label">Employee Department</label>
