...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient']))
		{
			...
			$query="insert into HMO(regdate,code,name) values(?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sss',$date,$pat_code,$pat_compname);
			$stmt->execute();
			/*
			...
			*/ 
			...
			if($stmt)
			{
				$success = "HMO Registration Sussefully";
			}
			else {
...
<html lang="en">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">HMO Registration Form</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="inputAddress" class="col-form-label">HMO Name</label>
                                                <input required="required" type="text" class="form-control" name="name" id="inputAddress" placeholder="HMO Company Name">
                                            </div>
                                            ...
                                            <button type="submit" name="add_patient" class="ladda-button btn btn-primary" data-style="expand-right">CREATE HMO</button>
  ...
  <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title">List of HMO'S</h4>
                                    <div class="mb-2">
                                        <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" style="background-color:maroon;" class="datatable-1 table table-bordered table-striped   display" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone" style="color:white;">HMO Name</th>
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                                $ret="SELECT * FROM  HMO ORDER BY id DESC "; 
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_admin_HMOcompanycard.php?code=<?php echo $row->code;?>" class="badge badge-success"><i class="far fa-eye "></i> Register</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
