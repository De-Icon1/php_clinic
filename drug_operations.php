                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Drug Operation Portal</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="update_drug.php?id=<?php echo $row->id;?>&name=<?php echo $row->name;?>" class="btn btn-success pull-right">Stock In<img src="assets/images/ok.png" height="20" width="20"></a> <a href="remove_drug.php?id=<?php echo $row->id;?>&name=<?php echo $row->name;?>" class="btn btn-success pull-right">Remove<img src="assets/img/back.png" height="20" width="20"></a> <a href="drug_operations.php?del=<?php echo $row->id;?>" class="btn btn-success pull-right">Delete<img src="assets/images/del.png" height="20" width="20"></a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
