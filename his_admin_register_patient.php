...
//unlink($dir.'/'.$pimage);
			...
			$query="insert into antenatal(surname,firstname,middlename,code,reg_date,dob,age,address,phone,nok,nok_contact,marital,picture) values(?,?,?,?,?,?,?,?,?,?,?,?,?)";
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Individual Card Form</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
