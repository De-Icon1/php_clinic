...
if(isset($_GET['del'])){
    ...
    $id=$_GET['del'];
		...
		if(isset($_POST['genreport']))
		{
            ...
            header("location:visitdate_report.php?datefrm=$datefrm{$camp_q}");
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Daily Patient Visit Report</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <!--Add Patient Form-->
                                        <?php
                                        // Campus selector for this report
                                        if (isset($mysqli)) {
                                            $campuses = [];
                                        ...
                                        <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                                            ...
                                            <button type="submit" name="genreport" class="ladda-button btn btn-primary" >View Report</button>
