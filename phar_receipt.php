...
if(isset($_GET['inv']))
    $inv=$_GET['inv'];
    $date=$_GET['date'];
    $result = mysqli_query($mysqli, "SELECT * FROM pharmacy_invoice WHERE date='$date' AND pharmacyid='$inv' LIMIT 1");
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    $time  = "N/A";
       ...
       function getinvtot($mysqli,$date,$inv){
        $amnt=0;
           $result=mysqli_query($mysqli,"select * from pharmacy_invoice where date='$date' and pharmacyid='$inv'");
                                    ...
                                    <div class="table-responsive">
                                        <table id="" style="background-color:grey; width:100%;"  class="datatable-1 table table-bordered table-striped   display" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone" style="color:white; ">Pharmacy NO</th>
                                                <th data-hide="phone" style="color:white; ">Drug</th>
                                                <th data-hide="phone" style="color:white; ">Qnt</th>
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                                $ret="select * from pharmacy_invoice where date='$date' and pharmacyid='$inv' order by id ASC "; 
