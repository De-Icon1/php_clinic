...
//unlink($dir.'/'.$pimage);
            ...
            $query="insert into company_individual(fcode,Surname,Firstname,Lastname,reg_date,code,dob,age,address,marrital,phone,nok,nok_phone,picture) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('ssssssssssssss',$pat_fcode,$pat_surn,$pat_fname, $pat_lname,$date,$pat_code,$pat_dob,$pat_age,$pat_add,$pat_mstatus,$pat_phone,$pat_nok,$pat_noknum,$pat_pics);
            $stmt->execute();
            /*
            ...
            */ 
            ...
            if($stmt)
            {
                $success = "Company Registration Sussefully";
            }
            else {
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Company Individual Card Form</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                                             <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    <label for="inputCity" class="col-form-label"><h3>Company Code</h3></label>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="inputCity" class="col-form-label"><h3>Company Individual Code</h3></label>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input required="required" type="text" name="lname" class="form-control"  id="inputPassword4" placeholder="Patient`s Last Name">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input required="required" type="text" class="form-control" name="add" id="inputAddress" placeholder="Patient's Residential Addresss">
                                            </div>

                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    <label for="inputCity" class="col-form-label">Mobile Number</label>
                                                    <input required="required" type="text" name="phone" class="form-control" id="inputCity" placeholder="Mobile Number">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="inputCity" class="col-form-label">Patient NOK</label>
                                                    <input required="required" type="text" name="nok" class="form-control" id="inputCity" placeholder="Patient Next of Kin">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="inputCity" class="col-form-label">NOK Mobile Number</label>
                                                    <input required="required" type="text" name="noknumber" class="form-control" id="inputCity" placeholder="NOK Mobile Number">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="inputState" class="col-form-label">Marrital Status</label>
...
<div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title">List of Company Individuals</h4>
                                    <div class="mb-2">
                                        <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" style="background-color:grey;" class="datatable-1 table table-bordered table-striped   display" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone" style="color:white;">Company</th>
                                                ...
                                                <th data-hide="phone" style="color:white;">Lastname</th>
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                                $ret="SELECT * FROM  company_individual ORDER BY id DESC "; 
