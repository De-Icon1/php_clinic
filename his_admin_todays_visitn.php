...
<div class="row">
                                        ...
                                        <table id="demo-foo-filtering" style="background-color:grey;" class="datatable-1 table table-bordered table-striped   display" data-page-size="7">
                                            ...
                                            */
                                            ...
                                            $status = isset($_GET['status_filter'])
                                                ? $_GET['status_filter']
                                                : (isset($_POST['status_filter']) ? $_POST['status_filter'] : 'Not Yet');

                                            // Get campus/location from session (align with debug_sendsignal.php)
                                            $campus_id = isset($_SESSION['working_location_id']) && is_numeric($_SESSION['working_location_id'])
                                                ? (int) $_SESSION['working_location_id']
                                                : null;
                            ...
                            // Optional SQL debug: add &debug_sql=1 to URL when troubleshooting
                            debug_sql_block(
                                isset($_GET['debug_sql']) ? $_GET['debug_sql'] : null,
                                $status,
                                $campus_id,
                                $hascamp,
                                isset($ret) ? $ret : '',
