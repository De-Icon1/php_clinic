...
<?php
    ...
    if(isset($_POST['add_patient']))
    {
            ...
            scode,title,surname,firstname,middlename,staff_no,dept,faculty,reg_date,dob,age,gender,address,phone,email,nok,nok_contact,marital_status,picture) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('sssssssssssssssssss',$pat_scode, $pat_title,  $pat_surn, $pat_fname,  $pat_lname, $pat_staffno, $pat_dept, $pat_faculty, $date, $pat_dob, $pat_age,$gender, $pat_addr, $pat_phone, $pat_email, $nok, $noknumber, $mstatus, $pics);
            $stmt->execute();
            /*
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Staff Card Form</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            ...
                            <!--Add Patient Form-->
                                        <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" >
                                             ...
                                             <div class="form-group col-md-4">
                                                    <label for="inputCity" class="col-form-label"><h3>Staff Code</h3></label>
                                                    <input required="required" type="text" style="color:blue;" value="<?php echo $ind;  ?>" name="pat_scode" class="form-control" id="inputCity">
                                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" style="background-color:grey;" class="datatable-1 table table-bordered table-striped   display" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone" style="color:white;">StaffId</th>
                                                <th data-hide="phone" style="color:white;">Staffno</th>
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                                $ret="SELECT * FROM  staff ORDER BY id DESC "; 
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_admin_staff_individual.php?code=<?php echo $row->scode;?>" class="badge badge-success"><i class="far fa-eye "></i> View</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
