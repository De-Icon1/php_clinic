...
<?php
	...
	include('assets/inc/config.php');
		...
		if(isset($_POST['search']))
		{
            ...
            if($searching){
               echo "<script>location='his_admin_labinfo.php?id=$searching'</script>";
            }
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Searching Patient Lab Record</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                                             <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    <label for="inputCity" class="col-form-label"><h3>Enter Patient Labs Code</h3></label>
