...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient']))
		{
			...
			$pat_mame=$_POST['mname'];
			
            //sql to insert captured values
			$query="insert into family(surname,firstname,middlename,reg_date,code) values(?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssss',$pat_surn,$pat_fname, $pat_mname,$date,$pat_code);
			$stmt->execute();
			/*
...
<html lang="en">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Family Registration Form</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
  ...
  <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title">List of Families</h4>
                                    <div class="mb-2">
                                        <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" style="background-color:maroon;" class="datatable-1 table table-bordered table-striped   display" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone" style="color:white;">Family Code</th>
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                                $ret="SELECT * FROM  family ORDER BY id DESC "; 
