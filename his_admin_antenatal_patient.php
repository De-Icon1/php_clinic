...
<?php
	...
	include('assets/inc/config.php');
		...
		{
        // defensively read POST values
        $pat_code = isset($_POST['pat_acode']) ? $_POST['pat_acode'] : '';
        $date = isset($_POST['regdate']) ? $_POST['regdate'] : '';
            $pat_surn=$_POST['surn'];
...
//unlink($dir.'/'.$pimage);
                ...
                // move uploaded picture if present
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Ante Natal Registration Successful";
			}
			else {
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Ante Natal Card Form</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" >
                                             <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    <label for="inputCity" class="col-form-label"><h3>Ante Natal Code</h3></label>
...
<div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title">List of Individuals </h4>
                                    <div class="mb-2">
                                        <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" style="background-color:grey;" class="datatable-1 table table-bordered table-striped   display" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone" style="color:white;">AntenatalID</th>
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                                $ret="SELECT * FROM  antenatal ORDER BY id DESC "; 
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_admin_antenatal_patient.php?code=<?php echo $row->code;?>" class="badge badge-success"><i class="far fa-eye "></i> View</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
