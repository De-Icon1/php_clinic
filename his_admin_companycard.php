...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient']))
		{
			...
			$query="insert into company(regdate,code,name) values(?,?,?)";
...
<html lang="en">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Company Member Registration Form</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
  ...
  <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title">List of Companies</h4>
                                    <div class="mb-2">
                                        <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" style="background-color:maroon;" class="datatable-1 table table-bordered table-striped   display" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone" style="color:white;">Company Code</th>
                                                <th data-hide="phone" style="color:white;">Registration Date</th>
                                                <th data-hide="phone" style="color:white;">Company Name</th>
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                                $ret="SELECT * FROM  company ORDER BY id DESC "; 
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_admin_company_individualcard.php?code=<?php echo $row->code;?>" class="badge badge-success"><i class="far fa-eye "></i> View</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
