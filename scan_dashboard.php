<?php
  ...
  /* ============================================================
     WORKING LOCATION HANDLING (SHARED WITH NURSE/LAB MODELS)
  =============================================================== */
  if (isset($_POST['set_location'])) {
      ...
      // Preserve any existing query parameters (like scan_pick=1) on redirect
      $qs = $_GET;
  ...
  if (isset($_GET['clear_location'])) {
      ...
      // Preserve other query parameters (like scan_pick=1) when clearing location
      $qs = $_GET;
      unset($qs['clear_location']);
      $query = http_build_query($qs);
      $target = $_SERVER['PHP_SELF'] . ($query ? ('?' . $query) : '');
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php if (isset($_GET['scan_pick']) && $_GET['scan_pick'] == '1'): ?>

                        <!-- Scan Consumables Picking (per working location) -->
                        <div class="row mb-3">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="mb-3">Scan Consumables (Pick Items)</h4>
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-12 col-md-4">
                                                        <select name="working_location" class="form-control" required>
                                                            ...
                                                            <?php
                                                            $campuses_sd = $mysqli->query("SELECT id, name FROM campus_locations ORDER BY name ASC");
                                                            while($c = $campuses_sd->fetch_assoc()){
                                        ...
                                        <?php else: ?>
                                            <p>
                                                ...
                                                <a href="?clear_location=1&amp;scan_pick=1" class="btn btn-sm btn-warning ms-2">Change Location</a>
                                            </p>
                        ...
                        async function fetchScanConsumables() {
                            const res = await fetch('scan_dashboard.php?ajax=1');
                        ...
                        async function pickScanConsumable(id, maxQty) {
                            ...
                            const res = await fetch('scan_dashboard.php', {
                                method: 'POST',
                                body: formData
                            });
                            const data = await res.json();
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Company Patients</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                ...
                                                ?>
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $outpatient;?></span></h3>
                                                <p class="text-muted mb-1 text-truncate">Ante Nata Patients</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    //code for summing up number of in / admitted  patients 
                                                    $result ="SELECT count(*) FROM hmocompany_individual ";
                                                    $stmt = $mysqli->prepare($result);
                                                    $stmt->execute();
                                                    $stmt->bind_result($inpatient);
                                                    $stmt->fetch();
                                                ...
                                                ?>
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $inpatient;?></span></h3>
                                                <p class="text-muted mb-1 text-truncate">HMO Patients</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
