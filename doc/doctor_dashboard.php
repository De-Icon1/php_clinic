                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless table-hover table-centered m-0">
                                            ...
                                            <?php
                                                $date=date('Y-m-d');
                                                $ret="SELECT * FROM his_vitals where date='$date' ORDER BY id ASC "; 
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $row->vit_pat_number;?>
                                                    </td>    
                                                    <td>
                                                        <?php echo $row->vit_daterec;?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row->vit_bodytemp;?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row->vit_heartpulse;?>
                                                    </td>
                                                     <td>
                                                    ...
                                                    <td>
                                                        <a href="his_doc_view_single_patient.php?pat_id=<?php echo $row->vit_pat_number;?>&&pat_name=<?php echo $row->fullname;?>" class="btn btn-xs btn-success"><i class="mdi mdi-eye"></i> View</a>
                                                    </td>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
                                                </tr>
                                            </tbody>
                                            <?php }?>
