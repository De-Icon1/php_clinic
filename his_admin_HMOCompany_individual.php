...
//unlink($dir.'/'.$pimage);
            ...
            $query="insert into hmocompany_individual(hcode,code,Surname,Firstname,Lastname,reg_date,dob,age,address,marrital,phone,nok,nok_phone,picture) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('ssssssssssssss',$pat_fcode,$pat_code,$pat_surn,$pat_fname, $pat_lname,$date,$pat_dob,$pat_age,$pat_add,$pat_mstatus,$pat_phone,$pat_nok,$pat_noknum,$pat_pics);
            $stmt->execute();
            /*
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">HMO Company Individual Card Form</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" style="background-color:grey;" class="datatable-1 table table-bordered table-striped   display" data-page-size="7">
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                                $ret="SELECT * FROM  hmocompany_individual ORDER BY id DESC "; 
