    ...
    $pic=$row->picture;
		...
		if(isset($_POST['Send_Scan']))
		{
           $time= date("h:i:s" );
            ...
            $fname=$pat_surn." ".$pat_fname." ".$pat_lname;
            $pics=$pic;

			$query="insert into patient_scan(date,code,name,test,result,category) values(?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssss',$rdate,$pat_code,$fname,$test,$result,$category);
			$stmt->execute();
			/*
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Scan Test Sent Sussefully";
			}
			else {
                                        ...
                                        <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" >
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input required="required" type="text" name="lname" value="<?php echo $lname;?>" class="form-control"  id="inputPassword4" placeholder="Patient`s Last Name">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    <label for="inputCity" class="col-form-label">Scan Date</label>
                                                    <input required="required" type="text" name="dob" value="<?php echo $date=date('Y-m-d'); ?>" class="form-control" id="inputCity">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="inputCity" class="col-form-label">Select Scan Test</label>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="inputCity" class="col-form-label">Selected Scan</label>
                                            ...
                                            <button type="submit" name="Send_Scan" class="ladda-button btn btn-primary" data-style="expand-right">Register Test</button>
