                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="widget-rounded-circle card-box" style="background-color:darkblue;">
                                    <div class="row" >
                                        <div class="col-6">
                                            <div class="avatar-lg rounded-circle bg-soft-primary border-primary border">
                                                <img src="" width="0" height="50"></i>
                                            </div>
                                        </div>
                                        <div class="col-6" >
                                            <div class="text-right">
                                                <?php
                                                    ...
                                                    $stmt->close();
                                                ?>
                                                <h3 style="color:white;"><span data-plugin="counterup"><?php echo $outpatient;?></span></h3>
                                                <p class="text-muted mb-1 text-truncate"><strong><font color="white">CASH PAYMENT</font></strong> </p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                            ...
                            <!--Start InPatients-->
                            <div class="col-md-6 col-xl-4">
                                <div class="widget-rounded-circle card-box" style="background-color:darkred;">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="avatar-lg rounded-circle bg-soft-primary border-primary border">
                                                 <img src=""></i>
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    ...
                                                    $stmt->close();
                                                ?>
                                                <h3 style="color:white;"><span data-plugin="counterup"><?php echo $inpatient;?></span></h3>
                                                <p class="text-muted mb-1 text-truncate"><strong><font color="white">TRANSFER PAYMENT</font></strong></p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                            ...
                            <!--Start Employees-->
                            <div class="col-md-6 col-xl-4">
                                <div class="widget-rounded-circle card-box"style="background-color:darkgreen;">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="avatar-lg rounded-circle bg-soft-primary border-primary border">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    ...
                                                    $result ="SELECT count(*) FROM company_individual ";
                                                    $stmt = $mysqli->prepare($result);
                                                    $stmt->execute();
                                                    ...
                                                    $stmt->close();
                                                ?>
                                                <h3 style="color:white;"><span data-plugin="counterup"><?php echo $doc;?></span></h3>
                                                <p class="text-muted mb-1 text-truncate"><strong><font color="white">POS PAYMENT</font></strong></p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    ...
                                                    $stmt->close();
                                                ?>
                                                <h3 style="color:red;"><span data-plugin="counterup"><?php echo $outpatient;?></span></h3>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card-box">
                                    <h4 class="header-title mb-3">Today's Transactions</h4>
