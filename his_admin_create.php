...
//unlink($dir.'/'.$pimage);
			...
			$rc=$stmt->bind_param('sssssss',$pat_surn,$pat_fname,$email,$pwd,$dept, $staff_code,$pics);
			$stmt->execute();
			/*
			...
			*/ 
			...
			if($stmt)
			{
				$success = "New User Registration Sussefully";
			}
			else {
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">New Registration Form</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" >
                                             <div class="form-row">
                                                <div class="form-group col-md-3">
                                                    <label for="inputCity" class="col-form-label">Staff ID</label>
                                                    <input required="required" type="text" name="staff_code" class="form-control" placeholder="Enter Staff ID" id="inputCity">
                                                </div>
                                               
                                                    <div class="form-group col-md-3">
                                                    <label for="inputEmail4" class="col-form-label">Surname</label>
                                                    <input type="text" required="required" name="surn" class="form-control" id="inputEmail4" placeholder="Patient's First Name">
                                                </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" required="required" name="email" class="form-control" id="inputEmail4" placeholder="Email Address">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="inputEmail4" class="col-form-label">Enter Password</label>
                                                    <input type="Password" required="required" name="pwd" class="form-control" id="inputEmail4" placeholder="Enter Password">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="inputPassword4" class="col-form-label">Retype-Password</label>
                                                    <input required="required" type="Password" name="rpwd" class="form-control"  id="inputPassword4" placeholder="Re-Enter Password">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="inputState" class="col-form-label">Select Authorized Department</label>
                                            ...
                                            <button type="submit" name="user" class="ladda-button btn btn-primary" data-style="expand-right">Create New User</button>
