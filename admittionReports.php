...
<?php
	...
	include('assets/inc/config.php');
		...
		if(isset($_POST['report']))
		{
            ...
            $dateto=$_POST['dateto'];
            if($searching){
               echo "<script>location='admittedReport.php?id=$searching&df=$datefrm&dt=$dateto'</script>";
            }
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Nursing Reports On Admitted Patient</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                                             <div class="form-row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <label for="inputEmail4" class="col-form-label"><h3>Date From</h3></label>
                                                    <input type="date" required="required" name="datefrm" class="form-control" id="inputEmail4" placeholder="DD/MM/YYYY">
                                                </div>
                                                <div class="form-group col-md-3">
                                            ...
                                            <button type="submit" name="report" class="ladda-button btn btn-primary" data-style="expand-right">Process Patient Report</button>
                                        </form>
                                        <!--End Patient Form-->
