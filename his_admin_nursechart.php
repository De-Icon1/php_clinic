...
//unlink($dir.'/'.$pimage);
			...
			$query="insert into drugchart(patid,Fullname,session,date,drug,dose,time,comment,posted) values(?,?,?,?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssssssss',$patcode,$name, $sess,$date,$drug,$dose,$time, $comment,$doc_number);
			$stmt->execute();
			/*
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Nursing Drug Chat Posting</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" >
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-3">
                                                    <label for="inputEmail4" class="col-form-label">Patient Drug</label>
                                            ...
                                            <button type="submit" name="chart" class="ladda-button btn btn-primary" data-style="expand-right">Post Drug Chart</button>
                                            <hr>
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" style="background-color:grey;" class="datatable-1 table table-bordered table-striped   display" data-page-size="7">
                                            ...
                                            */
                                            $dated=date('Y-m-d');
                                                $ret="SELECT * FROM  drugchart where date='$date' ORDER BY id DESC "; 
                                                $stmt= $mysqli->prepare($ret) ;
                                                $stmt->execute() ;//ok
                                                $res=$stmt->get_result();
                                                $cnt=1;
