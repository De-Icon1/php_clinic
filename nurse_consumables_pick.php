...
/* ============================================================
   ...
   (pattern copied from consumables_ajax.php / lab consumables)
=============================================================== */
...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <!-- Left Sidebar: Nursing Navigation -->
            ...
            <div class="content-page">
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <h3 class="mb-4">Nurse Consumables (Pick Items)</h3>
    ...
    <?php else: ?>
        ...
        async function fetchNurseConsumables() {
            const res = await fetch('nurse_consumables_pick.php?ajax=1');
        ...
        async function pickNurseConsumable(id, maxQty) {
            ...
            const res = await fetch('nurse_consumables_pick.php', {
                method: 'POST',
                body: formData
            });
            const data = await res.json();
