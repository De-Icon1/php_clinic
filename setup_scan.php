...
//unlink($dir.'/'.$pimage);
            ...
            */ 
            ...
            if($stmt)
            {
                $success = "Scan Registered Sussefully";
            }
            else {
                $err = "Please Try Again Or Try Later";
            }
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Hospital Scan Registration Form</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                                             <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="inputEmail4" class="col-form-label"><h3>Scan Amount</h3></label>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="setup_scan.php?code=<?php echo $row->id;?>" class=""><img src="assets/images/ok.png" height="20" width="20"></a><a href="setup_scan.php?del=<?php echo $row->id;?>" class=""><img src="assets/images/del.png" height="20" width="20"></a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
